...
def run(job_input: IJobInput):
    ...
    if "last_date_amazon_transformed" in props:
        ...
        props["last_date_amazon_transformed"] = '2020-01-01' # <- !!! INITIALIZE THE "last_date_amazon" PROPERTY TO '2020-01-01' !!!
    ...
    reviews_raw = job_input.execute_query(
        f"""
        SELECT *
        FROM yankee_candle_reviews_dimira2
    ...
    if len(df) > 0:
        ...
        job_input.send_tabular_data_for_ingestion(
            ...
            destination_table="yankee_candle_review_transf_dimira" # <- !!! ENTER BETWEEN THE QUOTES THE NAME OF THE TABLE WE CREATED IN SCRIPT "03_create_yankee_candle_reviews_transformed.sql" !!!
        )

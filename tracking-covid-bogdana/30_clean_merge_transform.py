...
def run(job_input: IJobInput):
    ...
    cases = job_input.execute_query(
        f"""
        SELECT *
        FROM covid_cases_death_europe_daily_bogdana
    ...
    prev_day_df = job_input.execute_query(
        ...
        FROM covid_cases_death_europe_daily_bogdana as c
        JOIN covid_cases_death_europe_daily_bogdana as d
    ...
    if len(df_cases_deaths) > 0:
        ...
        job_input.send_tabular_data_for_ingestion(
            ...
            destination_table="covid_cases_death_europe_daily_bogdana"
        )

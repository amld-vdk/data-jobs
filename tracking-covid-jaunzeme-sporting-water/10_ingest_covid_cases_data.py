...
def run(job_input: IJobInput):
    ...
    if len(df_cases) > 0:
        job_input.send_tabular_data_for_ingestion(
            ...
            destination_table="covid_cases_europe_daily_jaunzeme_sporting_water" # PLEASE NOTE: THE TABLE NAME NEEDS TO BE WITHIN QUOTATIONS !!!
        )
    ...
    log.info(f"Success! {len(df_cases)} rows were inserted in table covid_cases_europe_daily_jaunzeme_sporting_water.")
    log.info("ATTENTION!!!")
